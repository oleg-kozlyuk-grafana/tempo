...
func TestFetchTagNames(t *testing.T) {
	...
	tr := []FlatSpan{
		{
			...
			RootServiceName:     "tr",
			RootSpanName:        "root",
			ResourceServiceName: "svc-01",
			ResourceAttrs: []Attribute{
				{Key: "generic-01", Value: []string{"bar"}},
				{Key: "resource-same", Value: []string{"foo"}},
			},
			ResourceDedicatedString01:   []string{"dedicated-01"},
			ScopeName:                   "scope-1",
			...
			SpanID:        []byte("0101"),
			Name:          "span-01-01",
			StatusMessage: "msg-01-01",
			Attrs: []Attribute{
				{Key: "generic-01-01", Value: []string{"foo"}},
				{Key: "span-same", Value: []string{"foo"}},
			},
			DedicatedString01: []string{"dedicated-01-01"},
			Events: []Event{
				{
					Name: "event-01-01",
					Attrs: []Attribute{
		...
		},
		{
			...
			SpanID:        []byte("0102"),
			Name:          "span-01-02",
			StatusMessage: "msg-01-02",
			Attrs: []Attribute{
				{Key: "generic-01-02", Value: []string{"foo"}},
			},
			DedicatedString01: []string{"dedicated-01-02"},
		},
		{
			TraceID:             traceID,
			RootServiceName:     "tr",
			RootSpanName:        "root",
			ResourceServiceName: "svc-02",
			ResourceAttrs: []Attribute{
				{Key: "generic-02", Value: []string{"bar"}},
				{Key: "resource-same", Value: []string{"foo"}},
			},
			ResourceDedicatedString01:   []string{"dedicated-02"},
			ScopeName:                   "scope-2",
			...
			SpanID:        []byte("0201"),
			Name:          "span-02-01",
			StatusMessage: "msg-02-01",
			Attrs: []Attribute{
				{Key: "generic-02-01", Value: []string{"foo"}},
				{Key: "span-same", Value: []string{"foo"}},
			},
			DedicatedString01: []string{"dedicated-02-01"},
			Events: []Event{
				{
					Name: "event-02-01",
					Attrs: []Attribute{
	...
	ctx := context.TODO()
	block := makeBackendBlockWithTraces(t, [][]FlatSpan{tr})
